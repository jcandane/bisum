...
setup(
  ...
  url = 'https://github.com/jcandane/bisum/tree/main',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/jcandane/bisum/archive/v_01.tar.gz',    # I explain this later on
